...
public:
  ...
  void st7735_write_char2(uint16_t x, uint16_t y, char ch, FontDef font, uint16_t color, uint16_t bgcolor);
  ...
  void st7735_write_str2(uint16_t x, uint16_t y, String str_data, FontDef font=Font_11x18, uint16_t color=ST7735_BLUE, uint16_t bgcolor=ST7735_BLACK);
	void st7735_write_str2(uint16_t x, uint16_t y, const char *str, FontDef font=Font_11x18, uint16_t color=ST7735_BLUE, uint16_t bgcolor=ST7735_BLACK);
